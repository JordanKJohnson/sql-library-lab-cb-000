...
def select_series_title_with_most_human_characters
  "SELECT title from series inner join characters on series.id = characters.series_id where characters.species = 'human' group by series.title order by count(series.id) desc;"
end
