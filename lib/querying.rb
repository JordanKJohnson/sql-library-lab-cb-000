...
def select_series_title_with_most_human_characters
  "SELECT title,count(series.id) as thecount from series inner join characters on series.character_id = characters.id where characters.species = 'Human' order by thecount desc;"
end
