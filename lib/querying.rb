...
def select_character_names_and_number_of_books_they_are_in
  "SELECT name,(SELECT COUNT() FROM books where characters.id = books.character_id) as booknum from characters left outer join books on characters.series_id = books.series_id GROUP BY characters.id;"
end
